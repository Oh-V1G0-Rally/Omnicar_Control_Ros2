...
def build_summary_row(test_info: dict, metrics: dict, result_dir: Path) -> dict:
    row = {
        ...
        "prediction_horizon": test_info["controller"].get("prediction_horizon", ""),
        "prediction_dt": test_info["controller"].get("prediction_dt", ""),
        "q_contour": test_info["controller"].get("q_contour", ""),
        "q_lag": test_info["controller"].get("q_lag", ""),
        "q_yaw": test_info["controller"].get("q_yaw", ""),
        "q_terminal_contour": test_info["controller"].get("q_terminal_contour", ""),
        "q_terminal_lag": test_info["controller"].get("q_terminal_lag", ""),
        "q_progress": test_info["controller"].get("q_progress", ""),
        "r_vx": test_info["controller"].get("r_vx", ""),
        "r_vy": test_info["controller"].get("r_vy", ""),
        "r_w": test_info["controller"].get("r_w", ""),
        "r_gamma_dot": test_info["controller"].get("r_gamma_dot", ""),
        "r_delta_vx": test_info["controller"].get("r_delta_vx", ""),
        "r_delta_vy": test_info["controller"].get("r_delta_vy", ""),
        "r_delta_w": test_info["controller"].get("r_delta_w", ""),
        "r_delta_gamma_dot": test_info["controller"].get("r_delta_gamma_dot", ""),
        "max_accel_x": test_info["controller"].get("max_accel_x", ""),
        "max_accel_y": test_info["controller"].get("max_accel_y", ""),
        "max_accel_w": test_info["controller"].get("max_accel_w", ""),
        "max_gamma_accel": test_info["controller"].get("max_gamma_accel", ""),
        "vx_samples": test_info["controller"].get("vx_samples", ""),
        "vy_samples": test_info["controller"].get("vy_samples", ""),
        "w_samples": test_info["controller"].get("w_samples", ""),
        "gamma_dot_samples": test_info["controller"].get("gamma_dot_samples", ""),
