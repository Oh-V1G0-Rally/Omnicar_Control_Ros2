...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "path_file",
            default_value="/home/c2sr/Omnicar_Control_Ros2/[02]Code/omnicar_ws/src/splines/FEUP/FEUP_rectangle.csv",
        ),
        DeclareLaunchArgument(
            "record_bag",
            default_value="true",
        ...
        DeclareLaunchArgument(
            "test_name",
            default_value="PF_YYYY-MM-DD_PATH_MAP_LINEAR_V01_R01",
        ),
