...
# Main Plot
ax.plot(x_log, y_log, label="Vehicle Path", linewidth=2)
ax.plot(left_x, left_y, 'r--', label=r'$\partial \mathcal{C}$')
ax.plot(right_x, right_y, 'r--')
ax.plot(left_x2, left_y2, 'k--', label=r'$\partial \mathcal{C}_\delta$')
ax.plot(right_x2, right_y2, 'k--')
